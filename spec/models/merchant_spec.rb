...
describe Merchant, type: :model do
  ...
  describe 'another class method' do
    before :each do
      ...
      #an invoice for each merchant
      @iv1 = create(:invoice, merchant: @m1, status: 'shipped', created_at: '2020-01-01T00:00:00 UTC')
      @iv2 = create(:invoice, merchant: @m1, status: 'shipped', created_at: '2020-01-01T00:00:00 UTC')

      #an invoice_item for each invoice, low quantity and price to high quantity and price
      @ii1 = create(:invoice_item, invoice: @iv1, item: @it1, quantity: 10, unit_price: 1) #rev = $10
      @ii2 = create(:invoice_item, invoice: @iv1, item: @it1, quantity: 20, unit_price: 2) #rev = $40
      @ii3 = create(:invoice_item, invoice: @iv1, item: @it1, quantity: 30, unit_price: 3) #rev = $90
      @ii4 = create(:invoice_item, invoice: @iv2, item: @it1, quantity: 30, unit_price: 3) #rev = $90
